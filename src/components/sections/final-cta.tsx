        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6 mb-12">
              <p className="text-lg font-bold text-[#0f172a]">
                The moment you start Syping, the clock flips. Your ideas move 5× faster, your tasks finish before they interrupt your flow.
              </p>
            ...
            <motion.button
              ...
              className="bg-[#6B5439] hover:bg-[#5A4530] text-white px-10 py-5 rounded-[24px] text-xl font-bold transition-all shadow-[0_6px_0_rgb(60,45,30)] flex items-center gap-3 group"
            >
              Start Syping. Start Winning Time. <ArrowRight className="group-hover:translate-x-1 transition-transform" />
            </motion.button>
          </div>

          <div className="relative">
             <div className="bg-white rounded-[48px] p-12 border border-[#6B5439]/10 shadow-2xl relative overflow-hidden">
                <div className="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-[#EAB308] via-[#FFD54F] to-[#EAB308]" />
                ...
                <div className="text-center py-8">
                   <div className="text-7xl md:text-8xl font-black text-[#0f172a] mb-2 flex items-center justify-center gap-2">
                      ...
                      <span className="text-4xl text-[#EAB308]">hrs</span>
                   </div>
                ...
                <div className="mt-12 grid grid-cols-2 gap-4">
                   ...
                   <div className="bg-[#FFFAE7] p-6 rounded-3xl border border-[#EAB308]/20">
                      <Award size={20} className="text-[#EAB308] mb-3" />
                ...
                <div className="mt-8 space-y-2">
                   <div className="flex justify-between items-end">
                      ...
                      <span className="text-sm font-bold text-[#EAB308]">84%</span>
                   </div>
                   <div className="h-3 bg-slate-100 rounded-full overflow-hidden">
                      <motion.div
                        ...
                        className="h-full bg-gradient-to-r from-[#EAB308] to-[#FFD54F]"
                      />
                   </div>
                </div>
             </div>
