...
export default function FinalCTA() {
  ...
  return (
    <section className="py-24 bg-[#FFFAE7] overflow-hidden w-full min-h-screen" aria-label="Time savings tracker">
      <div className="container mx-auto px-6 max-w-[1140px]">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <button
              className="bg-[#0f172a] hover:bg-[#1e293b] text-white px-10 py-5 rounded-[24px] text-xl font-bold transition-all shadow-[0_4px_0_rgb(0,0,0)] hover:shadow-[0_5px_0_rgb(0,0,0)] flex items-center gap-3 group border border-black active:shadow-none active:translate-y-[6px]"
              aria-label="Start using Syping now"
            >
