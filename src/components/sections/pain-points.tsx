        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-1 lg:order-2 relative">
            <div className="grid grid-cols-2 gap-4 h-[500px]">
              {/* Pain Side */}
              <div className="bg-slate-50 rounded-[32px] p-6 border border-slate-200 flex flex-col items-center justify-center text-center relative overflow-hidden">
              ...
              {/* Solution Side */}
              <div className="bg-[#FFFAE7] rounded-[32px] p-6 border border-[#EAB308]/20 flex flex-col items-center justify-center text-center relative overflow-hidden shadow-xl shadow-yellow-500/5">
            ...
            <div className="absolute -bottom-6 left-1/2 -translate-x-1/2 bg-[#0f172a] text-white px-6 py-3 rounded-full font-bold shadow-2xl z-10 whitespace-nowrap">
              Feel the difference.
            </div>
          </div>
        </div>
