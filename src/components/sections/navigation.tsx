...
const Logo = () => (
    <div className="flex items-center gap-3">
      <div className="relative w-16 h-24 bg-[#FFD54F] rounded-[14px] flex items-center justify-center overflow-hidden border border-[#E6A700] shadow-[0_4px_12px_rgba(255,213,79,0.25)]">
