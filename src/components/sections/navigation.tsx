      ...
      <div className="relative w-10 h-10 bg-[#FFD54F] rounded-[14px] flex items-center justify-center overflow-hidden border border-[#E6A700] shadow-[0_4px_12px_rgba(255,213,79,0.25)]">
        ...
        <div className="flex flex-col items-center gap-0.5 relative z-10">
          <div className="flex gap-1.5">
            <div className="w-1 h-1 bg-[#2D3748] rounded-full animate-pulse"></div>
            <div className="w-1 h-1 bg-[#2D3748] rounded-full animate-pulse"></div>
          </div>
          ...
          <div className="hidden lg:flex items-center gap-6">
            <div className="flex items-center gap-5 border-r border-[#e2e8f0] pr-6 mr-1">
               ...
               <button className="text-[#475569] hover:text-[#0f172a] transition-colors">
                ...
                <div className="flex items-center gap-3">
                  <button className="text-[15px] font-bold text-[#0f172a] hover:text-[#EAB308] px-4 transition-colors">Log in</button>
                  <button className="bg-[#0f172a] hover:bg-[#1e293b] text-white px-7 py-3 rounded-[18px] text-[15px] font-bold transition-all shadow-[0_4px_0_rgb(0,0,0)] hover:shadow-[0_5px_0_rgb(0,0,0)] active:shadow-none active:translate-y-[4px] border border-black flex items-center gap-2">
                    Download <Zap size={16} fill="currentColor" />
                  </button>
                </div>
