...
const Logo = () => (
    <div className="flex items-center">
      <img src="/2.webp" alt="SpeakLingo" className="h-[58px] w-auto object-contain" />
    </div>
);
...
const MegaMenu = ({ title, items, active, setActive, index }: any) => {
  ...
  return (
    ...
    >
      <button 
        className={`flex items-center gap-1.5 px-5 py-6 text-[15px] font-bold transition-colors ${isHovered ? 'text-[#F9A825]' : 'text-[#475569] hover:text-[#0f172a]'}`}
      >
        {title}
