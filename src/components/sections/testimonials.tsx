      ...
      <div className="container mx-auto px-6 max-w-[1140px]">
        <div className="text-center mb-16">
          ...
          <motion.div
            ...
            className={`p-12 rounded-[48px] !w-[500px] !h-[443px] ${t.color} border border-slate-100/50 flex flex-col justify-between group hover:shadow-[0_30px_60px_rgba(0,0,0,0.03)] transition-all duration-500 hover:-translate-y-1`}>
