...
const StatRow = ({ label, value, unit, icon: Icon, subLabel }: { label: string; value: string; unit?: string; icon?: React.ElementType; subLabel?: string }) => (
...
const CloudCallout = ({ label, description, position, icon: Icon }: { label: string; description: string; position: string; icon: React.ElementType }) => {
  return (
    ...
    <section className="py-32 bg-white overflow-hidden relative !w-full !h-[1559px]">
      <div className="container mx-auto px-6 max-w-[1400px]">
        <div className="text-center mb-32 space-y-6">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#F9A825]/10 rounded-full border border-[#F9A825]/20">
            <Sparkles size={14} className="text-[#F9A825]" />
            <span className="text-xs font-black uppercase tracking-wider text-[#6B5439]">Powered by AI</span>
          </div>
          ...
          <h2 className="text-6xl md:text-8xl font-black text-[#0f172a] leading-[0.85] tracking-tighter">
            ...
            <span className="text-[#F9A825] italic underline decoration-[#0f172a]/10 underline-offset-[12px]">Superpower.</span>
          </h2>
        </div>
        ...
        <div className="relative h-[850px] flex items-center justify-center">
              ...
              <div className="bg-[#FFFCEE] rounded-[50px] p-6 border-[3px] border-[#0f172a] overflow-hidden relative min-h-[580px]">
                ...
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="px-2 py-1 bg-green-100 rounded-full">
                    <span className="text-[10px] font-black text-green-700">EDU</span>
                  </div>
                </div>
                ...
                <div className="flex justify-between items-center mb-2 px-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[12px] font-bold text-slate-500">Learning Mode Active</span>
                  </div>
                </div>
                ...
                <div className="text-center text-[11px] font-bold text-slate-400 italic mb-3">
                  Speak naturally, learn constantly
                </div>

                {/* Grammar Feedback Area */}
                <div className="bg-[#FFD54F]/80 rounded-[24px] p-4 border-2 border-[#0f172a]/5 shadow-inner min-h-[140px] mb-3">
                  <div className="flex items-center gap-2 mb-2">
                    <CheckCircle2 size={14} className="text-green-600" />
                    <span className="text-[12px] font-bold text-green-700">Grammar: Excellent</span>
                  </div>
                  <p className="text-[13px] font-medium text-[#0f172a]">
                    "The research clearly demonstrates the significant impact of technology on modern education practices."
                  </p>
                  <div className="mt-2 flex items-center gap-1">
                    <Sparkles size={12} className="text-[#6B5439]" />
                    <span className="text-[10px] font-bold text-[#6B5439]">+3 vocabulary points</span>
                  </div>
                </div>
                ...
                <div className="mb-3">
                  <div className="flex justify-between items-center mb-2">
                    <h4 className="text-[14px] font-black text-[#0f172a]">Today's Progress</h4>
                    <Trophy size={14} className="text-[#F9A825]" />
                  </div>

                  <div className="bg-[#FFD54F] p-3 rounded-[32px] border-2 border-[#0f172a]/5 space-y-2">
                    <div className="grid grid-cols-3 gap-2">
                      <StatRow label="Grammar" value="98" unit="%" />
                      <StatRow label="Words" value="847" />
                      <StatRow label="Streak" value="12" unit="days" />
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-[#FFD54F] rounded-full py-2 px-4 flex items-center gap-2 mb-3 border border-[#0f172a]/10 shadow-sm">
                  ...
                  <span className="text-[9px] font-black text-[#0f172a]/60 truncate">Practice speaking for 10 mins daily</span>
                </div>
                ...
                <div className="flex items-center justify-between text-[10px] font-bold text-slate-400 px-2">
                  ...
                  <div className="bg-white border border-[#0f172a]/10 rounded-full px-3 py-0.5 flex items-center gap-1 shadow-sm">
                    ...
                    <span className="text-[#0f172a]/60">Active</span>
                  </div>
                </div>
          ...
          {/* Symmetrical Feature Callouts */}
          <CloudCallout
            label="Grammar Tutor"
            description="Real-time corrections with explanations. Learn why, not just what."
            icon={BookOpen}
          ...
          <CloudCallout
            ...
            description="Auto-format essays with proper citations and structure."
            icon={FileText}
          ...
          <CloudCallout
            ...
            description="ESL/EFL friendly with native language hints when needed."
            icon={Globe}
            position="left-[2%] top-[425px] -translate-y-1/2"
          />

          <CloudCallout
            label="Study Commands"
            description="'Start timer', 'Create flashcard' - voice control your study session."
            icon={Timer}
          ...
          <CloudCallout
            ...
            description="XP, streaks, and achievements that make learning addictive."
            icon={Trophy}
            position="left-[2%] top-[700px] -translate-y-1/2"
          />

          <CloudCallout
            label="Exam Safe Mode"
            description="Works offline - no cheating concerns. Perfect for exams."
            icon={WifiOff}
        ...
        <div className="mt-24 flex flex-col items-center gap-8">
          <div className="flex items-center gap-4 text-[#475569]">
            ...
            <p className="text-[12px] font-black uppercase tracking-[0.4em]">Ready to Excel?</p>
            <div className="h-px w-12 bg-[#0f172a]/10" />
          </div>
